...
describe ApplicationHelper do
  ...
  it "should create a default item category path for the nil category" do
    ...
    expect(any_item_category_path).to eq root_category_path
    expect(any_item_category_path(nil)).to eq root_category_path
    expect(any_item_category_path(double(ItemCategory, :id => nil))).to eq root_category_path
  end
