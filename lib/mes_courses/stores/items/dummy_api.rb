  ...
  module Stores
    module Items
      ...
      class DummyApi
        ...
        def self.new_default_store(uri = Carts::DummyApi.url)
          new(full_config(uri))
        end
        ...
        def self.shrinked_config(width, config = DummyApi.full_config)
        ...
        def initialize(attributes)
          ...
          @categories = DummyApi.news(attributes[:categories])
          @items = DummyApi.news(attributes[:items])
        end
